...
const opcodesMap = [
    ...
    /* 0xA8 XOR B       */ cpu => { inst.XOR8_R(cpu, 'B'); },
    /* 0xA9 XOR C       */ cpu => { inst.XOR8_R(cpu, 'C'); },
    /* 0xAA XOR D       */ cpu => { inst.XOR8_R(cpu, 'D'); },
    /* 0xAB XOR E       */ cpu => { inst.XOR8_R(cpu, 'E'); },
    /* 0xAC XOR H       */ cpu => { inst.XOR8_R(cpu, 'H'); },
    /* 0xAD XOR L       */ cpu => { inst.XOR8_R(cpu, 'L'); },
    /* 0xAE XOR (HL)    */ cpu => { inst.XOR8_$RR(cpu, 'HL'); },
    /* 0xAF XOR A       */ cpu => { inst.XOR8_R(cpu, 'A'); },
