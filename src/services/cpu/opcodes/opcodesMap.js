import { instructions as inst } from '../CpuInstructions';
...
const opcodesMap = [
    ...
    /* 0x35 INC (HL)    */ cpu => { inst.DEC8_$RR(cpu, 'HL'); },
    ...
    // OFFSET 0xA0 ----------------------------------------------------------
    /* 0xA0 AND B       */ cpu => { inst.AND_R(cpu, 'B'); },
    /* 0xA1 AND C       */ cpu => { inst.AND_R(cpu, 'C'); },
    /* 0xA2 AND D       */ cpu => { inst.AND_R(cpu, 'D'); },
    /* 0xA3 AND E       */ cpu => { inst.AND_R(cpu, 'E'); },
    /* 0xA4 AND H       */ cpu => { inst.AND_R(cpu, 'H'); },
    /* 0xA5 AND L       */ cpu => { inst.AND_R(cpu, 'L'); },
    /* 0xA6 AND (HL)    */ cpu => { inst.AND_$RR(cpu, 'HL'); },
    /* 0xA7 AND A       */ cpu => { inst.AND_R(cpu, 'A'); },
    /* 0xA8 XOR B       */ cpu => { inst.XOR_R(cpu, 'B'); },
    /* 0xA9 XOR C       */ cpu => { inst.XOR_R(cpu, 'C'); },
    /* 0xAA XOR D       */ cpu => { inst.XOR_R(cpu, 'D'); },
    /* 0xAB XOR E       */ cpu => { inst.XOR_R(cpu, 'E'); },
    /* 0xAC XOR H       */ cpu => { inst.XOR_R(cpu, 'H'); },
    /* 0xAD XOR L       */ cpu => { inst.XOR_R(cpu, 'L'); },
    /* 0xAE XOR (HL)    */ cpu => { inst.XOR_$RR(cpu, 'HL'); },
    /* 0xAF XOR A       */ cpu => { inst.XOR_R(cpu, 'A'); },

    // OFFSET 0xB0 ----------------------------------------------------------
    /* 0xB0 OR B        */ cpu => { inst.OR_R(cpu, 'B'); },
    /* 0xB1 OR C        */ cpu => { inst.OR_R(cpu, 'C'); },
    /* 0xB2 OR D        */ cpu => { inst.OR_R(cpu, 'D'); },
    /* 0xB3 OR E        */ cpu => { inst.OR_R(cpu, 'E'); },
    /* 0xB4 OR H        */ cpu => { inst.OR_R(cpu, 'H'); },
    /* 0xB5 OR L        */ cpu => { inst.OR_R(cpu, 'L'); },
    /* 0xB6 OR (HL)     */ cpu => { inst.OR_$RR(cpu, 'HL'); },
    /* 0xB7 OR A        */ cpu => { inst.OR_R(cpu, 'A'); },
    /* 0xB8 CP B        */ cpu => { inst.CP_R(cpu, 'B'); },
    /* 0xB9 CP C        */ cpu => { inst.CP_R(cpu, 'C'); },
    /* 0xBA CP D        */ cpu => { inst.CP_R(cpu, 'D'); },
    /* 0xBB CP E        */ cpu => { inst.CP_R(cpu, 'E'); },
    /* 0xBC CP H        */ cpu => { inst.CP_R(cpu, 'H'); },
    /* 0xBD CP L        */ cpu => { inst.CP_R(cpu, 'L'); },
    /* 0xBE CP (HL)     */ cpu => { inst.CP_$RR(cpu, 'HL'); },
    /* 0xBF CP A        */ cpu => { inst.CP_R(cpu, 'A'); },


    // OFFSET 0xC0 ----------------------------------------------------------
    /* 0xC0 RET NZ      */ cpu => { inst.RET_NF(cpu, 'Z'); },
    /* 0xC1 POP BC      */ cpu => { inst.POP_RR(cpu, 'BC'); },
    /* 0xC2 JP NZ,a16   */ cpu => { inst.JP_NF_a16(cpu, 'Z'); },
    /* 0xC3 JP a16      */ cpu => { inst.JP_a16(cpu); },
    /* 0xC4 CALL NZ,a16 */ cpu => { inst.CALL_NF_a16(cpu, 'Z'); },
    /* 0xC5 PUSH BC     */ cpu => { inst.PUSH_RR(cpu, 'BC'); },
    ...
    /* 0xD1 POP DE      */ cpu => { inst.POP_RR(cpu, 'DE'); },
    /* 0xD2 JP NC,a16   */ cpu => { inst.JP_NF_a16(cpu, 'C'); },
    /* 0xD3 NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xD4 CALL NC,a16 */ cpu => { inst.CALL_NF_a16(cpu, 'C'); },
    /* 0xD5 PUSH DE     */ cpu => { inst.POP_RR(cpu, 'DE'); },
    /* 0xD6 SUB d8      */ cpu => { inst.SUB8_d8(p); },
    /* 0xD7 RST 10H     */ cpu => { inst.RSTn(cpu, 0x10); },
    /* 0xD8 RET C       */ cpu => { inst.RET_F(cpu, 'C'); },
    /* 0xD9 RETI        */ cpu => { inst.RETI(cpu); },
    /* 0xDA JP C,a16    */ cpu => { inst.JP_F_a16(cpu, 'C'); },
    /* 0xDB NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xDC CALL C,a16  */ cpu => { inst.CALL_F_a16(cpu, 'C'); },
    /* 0xDD NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xDE SBC A,d8    */ cpu => { inst.SBC8_R_d8(cpu, 'A'); },
    /* 0xDF RST 18H     */ cpu => { inst.RST_XXH(cpu, 0x18); },

    // OFFSET 0xE0 ----------------------------------------------------------
    /* 0xE0 LDH (a8),A  */ cpu => { inst.LD8H_$a8_R(cpu, 'A'); },
    /* 0xE1 POP HL      */ cpu => { inst.POP_RR(cpu, 'HL'); },
    /* 0xE2 LD (C),A    */ cpu => { inst.LD8_$R_R(cpu, 'C', 'A'); },
    /* 0xE3 NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xE4 NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xE5 PUSH HL     */ cpu => { inst.PUSH_RR(cpu, 'HL'); },
    /* 0xE6 AND d8      */ cpu => { inst.AND8_d8(cpu); },
    /* 0xE7 RST 20H     */ cpu => { inst.RSTn(cpu, 0x20); },
    /* 0xE8 ADD SP,r8   */ cpu => { inst.ADD16_SP_r8(cpu); },
    /* 0xE9 JP (HL)     */ cpu => { inst.JP_$RR(cpu, 'HL'); },
    /* 0xEA LD (a16),A  */ cpu => { inst.LD8_$a16_R(cpu, 'A'); },
    /* 0xEB NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xEC NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xED NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xEE XOR d8      */ cpu => { inst.XOR8_d8(cpu); },
    /* 0xEF RST 28H     */ cpu => { inst.RST_XXH(cpu, 0x28); },

    // OFFSET 0xF0 ----------------------------------------------------------
    /* 0xF0 LDH A,(a8)  */ cpu => { inst.LD8H_R_$a8(cpu, 'A'); },
    /* 0xF1 POP AF      */ cpu => { inst.POP_RR(cpu, 'AF'); },
    /* 0xF2 LD A,(C)    */ cpu => { inst.LD8_R_$R(cpu, 'A', 'C'); },
    /* 0xF3 DI          */ cpu => { inst.DI(cpu); },
    /* 0xF4 NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xF5 PUSH AF     */ cpu => { inst.PUSH_RR(cpu, 'AF'); },
    /* 0xF6 OR d8       */ cpu => { inst.OR8_d8(cpu); },
    /* 0xF7 RST 30H     */ cpu => { inst.RSTn(cpu, 0x30); },
    ...
    /* 0xFC NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
    /* 0xFD NOT_IMPL    */ cpu => { inst.NOT_IMPLEMENTED(cpu); },
